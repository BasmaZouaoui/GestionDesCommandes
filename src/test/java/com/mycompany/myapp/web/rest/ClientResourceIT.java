...
class ClientResourceIT {
    ...
    private static final Integer DEFAULT_NUMEROCLIENT = 1;
    private static final Integer UPDATED_NUMEROCLIENT = 2;
    ...
    public static Client createEntity(EntityManager em) {
        Client client = new Client()
            .numeroclient(DEFAULT_NUMEROCLIENT)
            .nom(DEFAULT_NOM)
    ...
    public static Client createUpdatedEntity(EntityManager em) {
        Client client = new Client()
            .numeroclient(UPDATED_NUMEROCLIENT)
            .nom(UPDATED_NOM)
    ...
    void createClient() throws Exception {
        ...
        assertThat(testClient.getNumeroclient()).isEqualTo(DEFAULT_NUMEROCLIENT);
    ...
    void getAllClients() throws Exception {
        ...
        restClientMockMvc
            ...
            .andExpect(jsonPath("$.[*].numeroclient").value(hasItem(DEFAULT_NUMEROCLIENT)))
    ...
    void getClient() throws Exception {
        ...
        restClientMockMvc
            ...
            .andExpect(jsonPath("$.numeroclient").value(DEFAULT_NUMEROCLIENT))
    ...
    void putNewClient() throws Exception {
        ...
        Client testClient = clientList.get(clientList.size() - 1);
        assertThat(testClient.getNumeroclient()).isEqualTo(UPDATED_NUMEROCLIENT);
    ...
    void partialUpdateClientWithPatch() throws Exception {
        ...
        partialUpdatedClient.numeroclient(UPDATED_NUMEROCLIENT).nom(UPDATED_NOM).prenom(UPDATED_PRENOM);
